                            ...
                            @for($idx = 0; $idx < count($types); $idx++)
                                ...
                                @else
                                    <tr class="even gradeC">
                                        @endif
                                        <td>{{$types[$idx]->id}}</td>
                                        <td>{{$types[$idx]->code}}</td>
                                        <td>{{$types[$idx]->content}}</td>
                                        <td style="text-align: center"><img src="/{{$types[$idx]->image}}"/></td>
                                        <td>{{$types[$idx]->created_at}}</td>
                                        <td>
                                            <a class="btn-edit-item" data-id="{{$types[$idx]->id}}"
                                               href="javascript:void(0);"><i class="fa-2x glyphicon glyphicon-edit"></i></a>
                                            <a class="btn-del-item" data-id="{{$types[$idx]->id}}"
...
<!-- /#wrapper -->
<script>
    var datas = <?php echo json_encode($types); ?>;
</script>

<div class="modal fade" id="addModal" role="dialog">
    <div class="modal-dialog" style="width: fit-content;">
        <form id="id_add" action="/admin/types/add" method="post" enctype="multipart/form-data">
        @csrf
        <!-- Modal content-->
...
<div class="modal fade" id="editModal" role="dialog">
    <div class="modal-dialog" style="width: fit-content;">
        <form id="id_edit" action="/admin/types/edit" method="post" enctype="multipart/form-data">
        @csrf
        <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-sm">
        <form id="id_del" action="/admin/types/del" method="post" enctype="multipart/form-data">
            @csrf
