                                    ...
                                    <div class="fam_content">
                                        <div class="famille_bloc f_more" style="height: 230px;">
                                            <div class="famille wrapper">
                                                <div class="fam_img">
                                                    <div class="fam_img">
                                                        <img src="{{$groups[$idx]->image}}">
                                                        <div class="pointer"></div>
                                                    </div>
                                                    <div class="pointer"></div>
                                                </div>
                                                <div class="fam_txt">{{$groups[$idx]->content}}</div>
                                                <div class="fam_generiques middle" style="background-image:none;">
                                                    <ul class="ul_generiques">
                                                        @for($idxx = 0; $idxx < count($groups[$idx]->items); $idxx++)
                                                        <li>
                                                            <a href="/items?id_group_item={{$groups[$idx]->items[$idxx]->id}}">{{$groups[$idx]->items[$idxx]->content}}</a> <span
                                                                    class="nb_article_in_gen_boutique">({{$groups[$idx]->items[$idxx]->size}})</span></li>
                                                        @endfor
                                                    </ul>
                                                </div>
